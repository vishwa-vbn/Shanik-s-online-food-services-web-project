...
if(isset($_POST['add_product']))
{
   ...
   $image_folder = 'uploaded_img/'.$image;
    ...
    if(isset($_POST['update_product'])){
        ...
        $update_image_tmp_name = $_FILES['up_image']['tmp_name'];
        $update_folder = 'uploaded_img/'.$update_image;
        $update_old_image = $_POST['up_o_image'];
    ...
    if(isset($_GET['delete'])){
        ...
        $del_img=$deleted_image['image'];
        if (is_file ($del_img))
        {
        unlink('uploaded_img/'.$del_img);
        }
    ...
    <div class="box-container">
        ...
        <div class="name"> <?php echo $fetch_products['name']; ?> </div> 
         ...
         <div id="pbtns">
          ...
          <div class="update-btn"> <a href="admin_products.php?update=<?php echo $fetch_products['id']; ?>" >update</a> </div>
         </div>
        </div>
        <?php
            }
