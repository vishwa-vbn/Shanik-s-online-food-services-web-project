...
<?php include 'header.php'; ?>
   ...
   <div id="cat2">
    ...
    <section id="category">
     ...
     <input  class="a " type="submit"  name="veg_food"  value="Vegitarian"   >
  <img   id="catimg" src="./image/carrots.png" alt="carrot" >
    ...
    <input  class="a" type="submit"  name="non_veg_food"  value="Non-Veg"  >
   ...
   <input  class="a" type="submit"  name="Starters"  value="Starters" >
   ...
   <input    class="a" type="submit"  name="Beverages"  value="Beverages"  >
    ...
    <input  class="a" type="submit"  name="View_all"  value="View All"  >
...
<div class="box1"  >
          <form action="" method="post"  >
             ...
             <input class="rng" type="number" min="1"  name="food_quantity" value="1" class="qanty">
              ...
              <a onclick="onclickrev()"  id="lrev" href="home.php?revid=<?php echo $fetch_products['name'] ?>" >check review</a>
...
<div class="box1"  >
      <form action="" method="post"  >
         ...
         <input class="rng" type="number" min="1"  name="food_quantity" value="1" class="qanty">
          ...
          <input type="hidden" name="food_image" value="<?php echo $fetch_products['image']; ?>">
          <input  type="submit" value="add to cart" name="addtocart"  class="cartbtn">
          <!-- <button type="button"  name="rbtn"  value="<?php echo $iname ?>" onclick="reviewitem(this)" >check review</button> -->
         <a onclick="onclickrev()"  id="lrev" href="home.php?revid=<?php echo $fetch_products['name'] ?>" >check review</a>
...
<h1 id="copyhead"> CopyRight C2022 Shanik's</h1>
 ...
 <div style="text-align:center;"><p style="font-size:20px;">Customer Reviews</p></div>
